...
This is a Blender plugin and utility suite designed to ease the creation of original racing circuit addon models for Slightly Mad Studios' Madness Engine games Project CARS 2 and Reiza Studios' Automobilista 2.
## Limitations:
...
### Blender Addon
This Blender addon handles all Madness-specific track exporting and related authoring. 
...
- Import, export, and create new loose MTXs corresponding with a Blender material (defined independently from it, but organized alongside it)
...
- (WIP, see Limitations above) Export a LiveTrack Weathering-In MRDF (Madness "Machine-Readable Data Format") from an object with a specifically formatted Geometry Nodes setup (see Example Files)
